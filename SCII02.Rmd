---
title: "Representação no Espaço de Estados"
...
Sem perda de generalidade vamos considerar a EDO do sistema massa mola amortecedor
...
$$ G(s) = \frac{\mathcal{L\{y(t)\}}}{\mathcal{L\{u(t)\}}} = \frac{1}{ms^2 + bs + c} $$
